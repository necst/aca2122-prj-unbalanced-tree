...
`define TV_OUT_out_r_TDATA "../tv/rtldatafile/rtl.myproject_axi.autotvout_out_r_V_data_V.dat"
`define EGRESS_STATUS_out_r_TDATA "../tv/stream_size/stream_egress_status_out_r_V_data_V.dat"
`define TV_OUT_out_r_TKEEP "../tv/rtldatafile/rtl.myproject_axi.autotvout_out_r_V_keep_V.dat"
`define EGRESS_STATUS_out_r_TKEEP "../tv/stream_size/stream_egress_status_out_r_V_keep_V.dat"
`define TV_OUT_out_r_TSTRB "../tv/rtldatafile/rtl.myproject_axi.autotvout_out_r_V_strb_V.dat"
`define EGRESS_STATUS_out_r_TSTRB "../tv/stream_size/stream_egress_status_out_r_V_strb_V.dat"
`define TV_OUT_out_r_TUSER "../tv/rtldatafile/rtl.myproject_axi.autotvout_out_r_V_user_V.dat"
`define EGRESS_STATUS_out_r_TUSER "../tv/stream_size/stream_egress_status_out_r_V_user_V.dat"
`define TV_OUT_out_r_TLAST "../tv/rtldatafile/rtl.myproject_axi.autotvout_out_r_V_last_V.dat"
`define EGRESS_STATUS_out_r_TLAST "../tv/stream_size/stream_egress_status_out_r_V_last_V.dat"
`define TV_OUT_out_r_TID "../tv/rtldatafile/rtl.myproject_axi.autotvout_out_r_V_id_V.dat"
`define EGRESS_STATUS_out_r_TID "../tv/stream_size/stream_egress_status_out_r_V_id_V.dat"
`define TV_OUT_out_r_TDEST "../tv/rtldatafile/rtl.myproject_axi.autotvout_out_r_V_dest_V.dat"
`define EGRESS_STATUS_out_r_TDEST "../tv/stream_size/stream_egress_status_out_r_V_dest_V.dat"
