...
`define TV_IN_in_r_TDATA "../tv/cdatafile/c.myproject_axi.autotvin_in_r_V_data_V.dat"
`define INGRESS_STATUS_in_r_TDATA "../tv/stream_size/stream_ingress_status_in_r_V_data_V.dat"
`define TV_IN_in_r_TKEEP "../tv/cdatafile/c.myproject_axi.autotvin_in_r_V_keep_V.dat"
`define INGRESS_STATUS_in_r_TKEEP "../tv/stream_size/stream_ingress_status_in_r_V_keep_V.dat"
`define TV_IN_in_r_TSTRB "../tv/cdatafile/c.myproject_axi.autotvin_in_r_V_strb_V.dat"
`define INGRESS_STATUS_in_r_TSTRB "../tv/stream_size/stream_ingress_status_in_r_V_strb_V.dat"
`define TV_IN_in_r_TUSER "../tv/cdatafile/c.myproject_axi.autotvin_in_r_V_user_V.dat"
`define INGRESS_STATUS_in_r_TUSER "../tv/stream_size/stream_ingress_status_in_r_V_user_V.dat"
`define TV_IN_in_r_TLAST "../tv/cdatafile/c.myproject_axi.autotvin_in_r_V_last_V.dat"
`define INGRESS_STATUS_in_r_TLAST "../tv/stream_size/stream_ingress_status_in_r_V_last_V.dat"
`define TV_IN_in_r_TID "../tv/cdatafile/c.myproject_axi.autotvin_in_r_V_id_V.dat"
`define INGRESS_STATUS_in_r_TID "../tv/stream_size/stream_ingress_status_in_r_V_id_V.dat"
`define TV_IN_in_r_TDEST "../tv/cdatafile/c.myproject_axi.autotvin_in_r_V_dest_V.dat"
`define INGRESS_STATUS_in_r_TDEST "../tv/stream_size/stream_ingress_status_in_r_V_dest_V.dat"
...
module AESL_axi_s_in_r (
    ...
    initial begin : AXI_stream_driver_in_r_TUSER
        ...
        fp_ingress_status = $fopen(`INGRESS_STATUS_in_r_TUSER, "r");
        if (fp_ingress_status == 0) begin // Failed to open file
            $display("ERROR: Failed to open file \"%s\"!", `INGRESS_STATUS_in_r_TUSER);
            $finish;
        end
        token = read_token(fp);
        token_ingress_status = read_token(fp_ingress_status);
    ...
    initial begin : AXI_stream_driver_in_r_TID
        ...
        fp_ingress_status = $fopen(`INGRESS_STATUS_in_r_TID, "r");
        if (fp_ingress_status == 0) begin // Failed to open file
            $display("ERROR: Failed to open file \"%s\"!", `INGRESS_STATUS_in_r_TID);
            $finish;
        end
        token = read_token(fp);
        token_ingress_status = read_token(fp_ingress_status);
    ...
    initial begin : AXI_stream_driver_in_r_TDEST
        ...
        fp_ingress_status = $fopen(`INGRESS_STATUS_in_r_TDEST, "r");
        if (fp_ingress_status == 0) begin // Failed to open file
            $display("ERROR: Failed to open file \"%s\"!", `INGRESS_STATUS_in_r_TDEST);
            $finish;
        end
        token = read_token(fp);
        token_ingress_status = read_token(fp_ingress_status);
