...
wire   [0:0] comparison_6_fu_54_p2;
reg   [0:0] comparison_6_reg_140;
wire   [0:0] comparison_7_fu_60_p2;
reg   [0:0] comparison_7_reg_146;
wire   [0:0] activation_fu_66_p2;
reg   [0:0] activation_reg_151;
wire    ap_block_pp0_stage0;
wire   [0:0] and_ln133_fu_81_p2;
wire   [0:0] xor_ln135_fu_76_p2;
wire   [0:0] activation_11_fu_72_p2;
wire   [0:0] or_ln148_fu_91_p2;
wire   [0:0] activation_12_fu_85_p2;
...
assign activation_11_fu_72_p2 = (comparison_6_reg_140 & activation_reg_151);

assign activation_12_fu_85_p2 = (xor_ln135_fu_76_p2 & and_ln133_fu_81_p2);
...
assign and_ln133_fu_81_p2 = (comparison_7_reg_146 & activation_reg_151);
...
assign comparison_6_fu_54_p2 = (($signed(p_read2) < $signed(32'd4294866538)) ? 1'b1 : 1'b0);

assign comparison_7_fu_60_p2 = (($signed(p_read2) < $signed(32'd58940)) ? 1'b1 : 1'b0);

assign comparison_fu_48_p2 = (($signed(p_read1) < $signed(32'd4294912147)) ? 1'b1 : 1'b0);

assign or_ln148_3_fu_99_p2 = (or_ln148_fu_91_p2 | activation_12_fu_85_p2);

assign or_ln148_fu_91_p2 = (comparison_reg_135 | activation_11_fu_72_p2);

assign select_ln148_fu_105_p3 = ((or_ln148_fu_91_p2[0:0] == 1'b1) ? zext_ln148_fu_96_p1 : 2'd2);

assign xor_ln135_fu_76_p2 = (comparison_6_reg_140 ^ 1'd1);
