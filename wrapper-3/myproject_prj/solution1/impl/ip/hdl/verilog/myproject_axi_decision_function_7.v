...
assign icmp_ln1497_1_fu_54_p2 = (($signed(p_read) < $signed(32'd4294888266)) ? 1'b1 : 1'b0);

assign icmp_ln1497_2_fu_60_p2 = (($signed(p_read1) < $signed(32'd81380)) ? 1'b1 : 1'b0);

assign icmp_ln1497_fu_48_p2 = (($signed(p_read) < $signed(32'd73288)) ? 1'b1 : 1'b0);
