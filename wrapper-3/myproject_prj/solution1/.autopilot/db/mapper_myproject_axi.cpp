...
extern "C" void myproject_axi(__cosim_sC__*, __cosim_sC__*);
extern "C" void apatb_myproject_axi_hw(volatile void * __xlx_apatb_param_in, volatile void * __xlx_apatb_param_out) {
  ...
  vector<__cosim_sC__> __xlx_in_tmp_vec;
  while (!((hls::stream<__cosim_sC__>*)__xlx_apatb_param_in)->empty() && __xlx_in_V_tmp_Count < __xlx_in_V_read_Size) {
    __xlx_in_tmp_vec.push_back(((hls::stream<__cosim_sC__>*)__xlx_apatb_param_in)->read());
    __xlx_in_V_tmp_Count++;
  }
  ap_apatb_in_V_cap_bc = __xlx_in_tmp_vec.size();
  // store input buffer
  __cosim_sC__* __xlx_in_input_buffer= new __cosim_sC__[__xlx_in_tmp_vec.size()];
  ...
  __cosim_sC__* __xlx_out_input_buffer= new __cosim_sC__[ap_apatb_out_V_cap_bc];
  // DUT call
  myproject_axi(__xlx_in_input_buffer, __xlx_out_input_buffer);
  for (unsigned i = 0; i <ap_apatb_out_V_cap_bc; ++i)
    ((hls::stream<__cosim_sC__>*)__xlx_apatb_param_out)->write(__xlx_out_input_buffer[i]);
}
