...
unsigned int ap_apatb_in_V_user_V_cap_bc;
...
unsigned int ap_apatb_out_V_user_V_cap_bc;
...
unsigned int ap_apatb_out_V_id_V_cap_bc;
static AESL_RUNTIME_BC __xlx_out_V_id_V_V_size_Reader("../tv/stream_size/stream_size_out_out_V_id_V.dat");
unsigned int ap_apatb_out_V_dest_V_cap_bc;
static AESL_RUNTIME_BC __xlx_out_V_dest_V_V_size_Reader("../tv/stream_size/stream_size_out_out_V_dest_V.dat");
extern "C" void myproject_axi(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
extern "C" void apatb_myproject_axi_hw(volatile void * __xlx_apatb_param_in_V_data_V, volatile void * __xlx_apatb_param_in_V_keep_V, volatile void * __xlx_apatb_param_in_V_strb_V, volatile void * __xlx_apatb_param_in_V_user_V, volatile void * __xlx_apatb_param_in_V_last_V, volatile void * __xlx_apatb_param_in_V_id_V, volatile void * __xlx_apatb_param_in_V_dest_V, volatile void * __xlx_apatb_param_out_V_data_V, volatile void * __xlx_apatb_param_out_V_keep_V, volatile void * __xlx_apatb_param_out_V_strb_V, volatile void * __xlx_apatb_param_out_V_user_V, volatile void * __xlx_apatb_param_out_V_last_V, volatile void * __xlx_apatb_param_out_V_id_V, volatile void * __xlx_apatb_param_out_V_dest_V) {
  ...
  ap_apatb_in_V_user_V_cap_bc = __xlx_in_V_user_V_tmp_vec.size();
  // store input buffer
  ...
  ap_apatb_in_V_id_V_cap_bc = __xlx_in_V_id_V_tmp_vec.size();
  // store input buffer
  ...
  ap_apatb_in_V_dest_V_cap_bc = __xlx_in_V_dest_V_tmp_vec.size();
  // store input buffer
  ...
  int* __xlx_out_V_data_V_input_buffer= new int[ap_apatb_out_V_data_V_cap_bc];
  ...
  ap_apatb_out_V_user_V_cap_bc = __xlx_out_V_user_V_V_size_Reader.read_size();
  char* __xlx_out_V_user_V_input_buffer= new char[ap_apatb_out_V_user_V_cap_bc];
  ...
  ap_apatb_out_V_id_V_cap_bc = __xlx_out_V_id_V_V_size_Reader.read_size();
  char* __xlx_out_V_id_V_input_buffer= new char[ap_apatb_out_V_id_V_cap_bc];
  //Create input buffer for out_V_dest_V
  ap_apatb_out_V_dest_V_cap_bc = __xlx_out_V_dest_V_V_size_Reader.read_size();
  char* __xlx_out_V_dest_V_input_buffer= new char[ap_apatb_out_V_dest_V_cap_bc];
  // DUT call
  myproject_axi(__xlx_in_V_data_V_input_buffer, __xlx_in_V_keep_V_input_buffer, __xlx_in_V_strb_V_input_buffer, __xlx_in_V_user_V_input_buffer, __xlx_in_V_last_V_input_buffer, __xlx_in_V_id_V_input_buffer, __xlx_in_V_dest_V_input_buffer, __xlx_out_V_data_V_input_buffer, __xlx_out_V_keep_V_input_buffer, __xlx_out_V_strb_V_input_buffer, __xlx_out_V_user_V_input_buffer, __xlx_out_V_last_V_input_buffer, __xlx_out_V_id_V_input_buffer, __xlx_out_V_dest_V_input_buffer);
  ...
  for (unsigned i = 0; i <ap_apatb_out_V_user_V_cap_bc; ++i)
  ...
  for (unsigned i = 0; i <ap_apatb_out_V_id_V_cap_bc; ++i)
    ((hls::stream<char>*)__xlx_apatb_param_out_V_id_V)->write(__xlx_out_V_id_V_input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb_out_V_dest_V_cap_bc; ++i)
