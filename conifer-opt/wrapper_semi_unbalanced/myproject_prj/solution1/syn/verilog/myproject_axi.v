...
(* CORE_GENERATION_INFO="myproject_axi_myproject_axi,hls_ip_2021_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-e,HLS_INPUT_CLOCK=7.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.884866,HLS_SYN_LAT=21,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=952,HLS_SYN_LUT=7336,HLS_VERSION=2021_2}" *)
...
reg   [31:0] out_local_V_reg_622;
wire    ap_CS_fsm_state5;
reg   [0:0] s_reg_628;
wire   [31:0] sub_i_i_fu_271_p2;
reg   [31:0] sub_i_i_reg_634;
wire   [0:0] tobool_i_i_fu_277_p2;
reg   [0:0] tobool_i_i_reg_639;
wire    ap_CS_fsm_state6;
wire   [31:0] tmp_V_fu_282_p3;
reg   [31:0] tmp_V_reg_644;
wire   [31:0] sub_ln997_fu_305_p2;
reg   [31:0] sub_ln997_reg_649;
wire   [0:0] icmp_ln1011_fu_399_p2;
reg   [0:0] icmp_ln1011_reg_655;
wire   [0:0] select_ln1011_fu_419_p3;
reg   [0:0] select_ln1011_reg_660;
wire   [7:0] trunc_ln996_fu_427_p1;
...
reg   [31:0] p_Result_3_fu_287_p4;
reg   [31:0] l_fu_297_p3;
wire   [31:0] lsb_index_fu_311_p2;
wire   [30:0] tmp_fu_317_p4;
wire   [5:0] trunc_ln1000_fu_333_p1;
wire   [5:0] sub_ln1000_fu_337_p2;
wire   [31:0] zext_ln1000_fu_343_p1;
wire   [31:0] lshr_ln1000_fu_347_p2;
wire   [31:0] shl_ln1002_fu_353_p2;
wire   [31:0] or_ln1002_1_fu_359_p2;
wire   [31:0] and_ln1002_fu_365_p2;
wire   [0:0] tmp_2_fu_377_p3;
wire   [0:0] p_Result_4_fu_391_p3;
wire   [0:0] xor_ln1002_fu_385_p2;
wire   [0:0] icmp_ln999_fu_327_p2;
wire   [0:0] icmp_ln1002_fu_371_p2;
wire   [0:0] select_ln999_fu_411_p3;
wire   [0:0] and_ln1002_1_fu_405_p2;
wire   [31:0] sub_ln1012_fu_438_p2;
wire   [63:0] zext_ln1010_fu_435_p1;
wire   [63:0] zext_ln1012_fu_443_p1;
wire   [31:0] add_ln1011_fu_453_p2;
wire   [63:0] zext_ln1011_fu_458_p1;
wire   [63:0] lshr_ln1011_fu_462_p2;
wire   [63:0] shl_ln1012_fu_447_p2;
wire   [63:0] m_fu_468_p3;
wire   [63:0] zext_ln1014_fu_475_p1;
wire   [63:0] m_2_fu_478_p2;
wire   [62:0] m_5_fu_484_p4;
wire   [0:0] p_Result_s_fu_498_p3;
wire   [7:0] sub_ln1017_fu_514_p2;
wire   [7:0] select_ln996_fu_506_p3;
wire   [7:0] add_ln1017_fu_519_p2;
wire   [63:0] zext_ln1015_fu_494_p1;
wire   [8:0] tmp_1_fu_525_p3;
wire   [63:0] p_Result_5_fu_532_p5;
wire   [31:0] LD_fu_544_p1;
reg   [7:0] ap_NS_fsm;
...
assign LD_fu_544_p1 = p_Result_5_fu_532_p5[31:0];

assign add_ln1011_fu_453_p2 = ($signed(sub_ln997_reg_649) + $signed(32'd4294967271));

assign add_ln1017_fu_519_p2 = (sub_ln1017_fu_514_p2 + select_ln996_fu_506_p3);

assign and_ln1002_1_fu_405_p2 = (xor_ln1002_fu_385_p2 & p_Result_4_fu_391_p3);

assign and_ln1002_fu_365_p2 = (tmp_V_fu_282_p3 & or_ln1002_1_fu_359_p2);
...
assign icmp_ln1002_fu_371_p2 = ((and_ln1002_fu_365_p2 != 32'd0) ? 1'b1 : 1'b0);

assign icmp_ln1011_fu_399_p2 = (($signed(lsb_index_fu_311_p2) > $signed(32'd0)) ? 1'b1 : 1'b0);

assign icmp_ln999_fu_327_p2 = (($signed(tmp_fu_317_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);

assign in_r_TREADY = regslice_both_in_r_V_data_V_U_ack_in;


always @ (p_Result_3_fu_287_p4) begin
    if (p_Result_3_fu_287_p4[0] == 1'b1) begin
        l_fu_297_p3 = 32'd0;
    end else if (p_Result_3_fu_287_p4[1] == 1'b1) begin
        l_fu_297_p3 = 32'd1;
    end else if (p_Result_3_fu_287_p4[2] == 1'b1) begin
        l_fu_297_p3 = 32'd2;
    end else if (p_Result_3_fu_287_p4[3] == 1'b1) begin
        l_fu_297_p3 = 32'd3;
    end else if (p_Result_3_fu_287_p4[4] == 1'b1) begin
        l_fu_297_p3 = 32'd4;
    end else if (p_Result_3_fu_287_p4[5] == 1'b1) begin
        l_fu_297_p3 = 32'd5;
    end else if (p_Result_3_fu_287_p4[6] == 1'b1) begin
        l_fu_297_p3 = 32'd6;
    end else if (p_Result_3_fu_287_p4[7] == 1'b1) begin
        l_fu_297_p3 = 32'd7;
    end else if (p_Result_3_fu_287_p4[8] == 1'b1) begin
        l_fu_297_p3 = 32'd8;
    end else if (p_Result_3_fu_287_p4[9] == 1'b1) begin
        l_fu_297_p3 = 32'd9;
    end else if (p_Result_3_fu_287_p4[10] == 1'b1) begin
        l_fu_297_p3 = 32'd10;
    end else if (p_Result_3_fu_287_p4[11] == 1'b1) begin
        l_fu_297_p3 = 32'd11;
    end else if (p_Result_3_fu_287_p4[12] == 1'b1) begin
        l_fu_297_p3 = 32'd12;
    end else if (p_Result_3_fu_287_p4[13] == 1'b1) begin
        l_fu_297_p3 = 32'd13;
    end else if (p_Result_3_fu_287_p4[14] == 1'b1) begin
        l_fu_297_p3 = 32'd14;
    end else if (p_Result_3_fu_287_p4[15] == 1'b1) begin
        l_fu_297_p3 = 32'd15;
    end else if (p_Result_3_fu_287_p4[16] == 1'b1) begin
        l_fu_297_p3 = 32'd16;
    end else if (p_Result_3_fu_287_p4[17] == 1'b1) begin
        l_fu_297_p3 = 32'd17;
    end else if (p_Result_3_fu_287_p4[18] == 1'b1) begin
        l_fu_297_p3 = 32'd18;
    end else if (p_Result_3_fu_287_p4[19] == 1'b1) begin
        l_fu_297_p3 = 32'd19;
    end else if (p_Result_3_fu_287_p4[20] == 1'b1) begin
        l_fu_297_p3 = 32'd20;
    end else if (p_Result_3_fu_287_p4[21] == 1'b1) begin
        l_fu_297_p3 = 32'd21;
    end else if (p_Result_3_fu_287_p4[22] == 1'b1) begin
        l_fu_297_p3 = 32'd22;
    end else if (p_Result_3_fu_287_p4[23] == 1'b1) begin
        l_fu_297_p3 = 32'd23;
    end else if (p_Result_3_fu_287_p4[24] == 1'b1) begin
        l_fu_297_p3 = 32'd24;
    end else if (p_Result_3_fu_287_p4[25] == 1'b1) begin
        l_fu_297_p3 = 32'd25;
    end else if (p_Result_3_fu_287_p4[26] == 1'b1) begin
        l_fu_297_p3 = 32'd26;
    end else if (p_Result_3_fu_287_p4[27] == 1'b1) begin
        l_fu_297_p3 = 32'd27;
    end else if (p_Result_3_fu_287_p4[28] == 1'b1) begin
        l_fu_297_p3 = 32'd28;
    end else if (p_Result_3_fu_287_p4[29] == 1'b1) begin
        l_fu_297_p3 = 32'd29;
    end else if (p_Result_3_fu_287_p4[30] == 1'b1) begin
        l_fu_297_p3 = 32'd30;
    end else if (p_Result_3_fu_287_p4[31] == 1'b1) begin
        l_fu_297_p3 = 32'd31;
    end else begin
        l_fu_297_p3 = 32'd32;
    end
...
assign lsb_index_fu_311_p2 = ($signed(sub_ln997_fu_305_p2) + $signed(32'd4294967272));

assign lshr_ln1000_fu_347_p2 = 32'd4294967295 >> zext_ln1000_fu_343_p1;

assign lshr_ln1011_fu_462_p2 = zext_ln1010_fu_435_p1 >> zext_ln1011_fu_458_p1;

assign m_2_fu_478_p2 = (m_fu_468_p3 + zext_ln1014_fu_475_p1);

assign m_5_fu_484_p4 = {{m_2_fu_478_p2[63:1]}};

assign m_fu_468_p3 = ((icmp_ln1011_reg_655[0:0] == 1'b1) ? lshr_ln1011_fu_462_p2 : shl_ln1012_fu_447_p2);

assign or_ln1002_1_fu_359_p2 = (shl_ln1002_fu_353_p2 | lshr_ln1000_fu_347_p2);

assign out_r_TDATA_int_regslice = ((tobool_i_i_reg_639[0:0] == 1'b1) ? 32'd0 : LD_fu_544_p1);

assign out_r_TVALID = regslice_both_out_r_V_data_V_U_vld_out;

integer ap_tvar_int_0;

always @ (tmp_V_fu_282_p3) begin
    for (ap_tvar_int_0 = 32 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 31 - 0) begin
            p_Result_3_fu_287_p4[ap_tvar_int_0] = 1'b0;
        end else begin
            p_Result_3_fu_287_p4[ap_tvar_int_0] = tmp_V_fu_282_p3[31 - ap_tvar_int_0];
        end
    end
end

assign p_Result_4_fu_391_p3 = tmp_V_fu_282_p3[lsb_index_fu_311_p2];

assign p_Result_5_fu_532_p5 = {{zext_ln1015_fu_494_p1[63:32]}, {tmp_1_fu_525_p3}, {zext_ln1015_fu_494_p1[22:0]}};

assign p_Result_s_fu_498_p3 = m_2_fu_478_p2[32'd25];

assign select_ln1011_fu_419_p3 = ((icmp_ln1011_fu_399_p2[0:0] == 1'b1) ? select_ln999_fu_411_p3 : and_ln1002_1_fu_405_p2);

assign select_ln996_fu_506_p3 = ((p_Result_s_fu_498_p3[0:0] == 1'b1) ? 8'd127 : 8'd126);

assign select_ln999_fu_411_p3 = ((icmp_ln999_fu_327_p2[0:0] == 1'b1) ? icmp_ln1002_fu_371_p2 : p_Result_4_fu_391_p3);

assign shl_ln1002_fu_353_p2 = 32'd1 << lsb_index_fu_311_p2;

assign shl_ln1012_fu_447_p2 = zext_ln1010_fu_435_p1 << zext_ln1012_fu_443_p1;

assign sub_i_i_fu_271_p2 = (32'd0 - grp_myproject_fu_209_ap_return);

assign sub_ln1000_fu_337_p2 = ($signed(6'd57) - $signed(trunc_ln1000_fu_333_p1));

assign sub_ln1012_fu_438_p2 = (32'd25 - sub_ln997_reg_649);

assign sub_ln1017_fu_514_p2 = (8'd16 - trunc_ln996_reg_665);

assign sub_ln997_fu_305_p2 = (32'd32 - l_fu_297_p3);

assign tmp_1_fu_525_p3 = {{s_reg_628}, {add_ln1017_fu_519_p2}};

assign tmp_2_fu_377_p3 = lsb_index_fu_311_p2[32'd31];

assign tmp_V_fu_282_p3 = ((s_reg_628[0:0] == 1'b1) ? sub_i_i_reg_634 : out_local_V_reg_622);

assign tmp_fu_317_p4 = {{lsb_index_fu_311_p2[31:1]}};

assign tobool_i_i_fu_277_p2 = ((out_local_V_reg_622 == 32'd0) ? 1'b1 : 1'b0);

assign trunc_ln1000_fu_333_p1 = sub_ln997_fu_305_p2[5:0];

assign trunc_ln996_fu_427_p1 = l_fu_297_p3[7:0];

assign xor_ln1002_fu_385_p2 = (tmp_2_fu_377_p3 ^ 1'd1);

assign zext_ln1000_fu_343_p1 = sub_ln1000_fu_337_p2;

assign zext_ln1010_fu_435_p1 = tmp_V_reg_644;

assign zext_ln1011_fu_458_p1 = add_ln1011_fu_453_p2;

assign zext_ln1012_fu_443_p1 = sub_ln1012_fu_438_p2;

assign zext_ln1014_fu_475_p1 = select_ln1011_reg_660;

assign zext_ln1015_fu_494_p1 = m_5_fu_484_p4;
