...
HD_PWD='/home/nghielme/PycharmProjects/aca-project/wrapper_heavily_unbalanced/myproject_vivado_accelerator/project_1.runs/design_1_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
