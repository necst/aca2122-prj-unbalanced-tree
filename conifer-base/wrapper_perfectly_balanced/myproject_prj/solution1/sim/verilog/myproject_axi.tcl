...
add_wave /apatb_myproject_axi_top/AESL_inst_myproject_axi/out_r_TDEST -into $return_group -radix hex
add_wave /apatb_myproject_axi_top/AESL_inst_myproject_axi/out_r_TID -into $return_group -radix hex
add_wave /apatb_myproject_axi_top/AESL_inst_myproject_axi/out_r_TLAST -into $return_group -color #ffff00 -radix hex
add_wave /apatb_myproject_axi_top/AESL_inst_myproject_axi/out_r_TUSER -into $return_group -radix hex
...
add_wave /apatb_myproject_axi_top/AESL_inst_myproject_axi/in_r_TDEST -into $return_group -radix hex
add_wave /apatb_myproject_axi_top/AESL_inst_myproject_axi/in_r_TID -into $return_group -radix hex
add_wave /apatb_myproject_axi_top/AESL_inst_myproject_axi/in_r_TLAST -into $return_group -color #ffff00 -radix hex
add_wave /apatb_myproject_axi_top/AESL_inst_myproject_axi/in_r_TUSER -into $return_group -radix hex
...
add_wave /apatb_myproject_axi_top/ap_c_n_tvin_trans_num_in_r_V_user_V -into $tb_simstatus_group -radix hex
add_wave /apatb_myproject_axi_top/ap_c_n_tvin_trans_num_in_r_V_last_V -into $tb_simstatus_group -radix hex
add_wave /apatb_myproject_axi_top/ap_c_n_tvin_trans_num_in_r_V_id_V -into $tb_simstatus_group -radix hex
add_wave /apatb_myproject_axi_top/ap_c_n_tvin_trans_num_in_r_V_dest_V -into $tb_simstatus_group -radix hex
...
add_wave /apatb_myproject_axi_top/ap_c_n_tvout_trans_num_out_r_V_user_V -into $tb_simstatus_group -radix hex
add_wave /apatb_myproject_axi_top/ap_c_n_tvout_trans_num_out_r_V_last_V -into $tb_simstatus_group -radix hex
add_wave /apatb_myproject_axi_top/ap_c_n_tvout_trans_num_out_r_V_id_V -into $tb_simstatus_group -radix hex
add_wave /apatb_myproject_axi_top/ap_c_n_tvout_trans_num_out_r_V_dest_V -into $tb_simstatus_group -radix hex
...
add_wave /apatb_myproject_axi_top/LENGTH_in_r_V_user_V -into $tb_portdepth_group -radix hex
add_wave /apatb_myproject_axi_top/LENGTH_in_r_V_last_V -into $tb_portdepth_group -radix hex
add_wave /apatb_myproject_axi_top/LENGTH_in_r_V_id_V -into $tb_portdepth_group -radix hex
add_wave /apatb_myproject_axi_top/LENGTH_in_r_V_dest_V -into $tb_portdepth_group -radix hex
...
add_wave /apatb_myproject_axi_top/LENGTH_out_r_V_user_V -into $tb_portdepth_group -radix hex
add_wave /apatb_myproject_axi_top/LENGTH_out_r_V_last_V -into $tb_portdepth_group -radix hex
add_wave /apatb_myproject_axi_top/LENGTH_out_r_V_id_V -into $tb_portdepth_group -radix hex
add_wave /apatb_myproject_axi_top/LENGTH_out_r_V_dest_V -into $tb_portdepth_group -radix hex
set tbcoutputgroup [add_wave_group "C Outputs" -into $testbenchgroup]
set tb_return_group [add_wave_group return(axi_slave) -into $tbcoutputgroup]
add_wave /apatb_myproject_axi_top/out_r_TDEST -into $tb_return_group -radix hex
add_wave /apatb_myproject_axi_top/out_r_TID -into $tb_return_group -radix hex
add_wave /apatb_myproject_axi_top/out_r_TLAST -into $tb_return_group -color #ffff00 -radix hex
add_wave /apatb_myproject_axi_top/out_r_TUSER -into $tb_return_group -radix hex
...
add_wave /apatb_myproject_axi_top/in_r_TDEST -into $tb_return_group -radix hex
add_wave /apatb_myproject_axi_top/in_r_TID -into $tb_return_group -radix hex
add_wave /apatb_myproject_axi_top/in_r_TLAST -into $tb_return_group -color #ffff00 -radix hex
add_wave /apatb_myproject_axi_top/in_r_TUSER -into $tb_return_group -radix hex
