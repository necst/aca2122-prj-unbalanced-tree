...
HD_PWD='/home/nghielme/PycharmProjects/aca-project/conifer-base/wrapper_semi_unbalanced/myproject_vivado_accelerator/project_1.runs/design_1_xbar_0_synth_1'
cd "$HD_PWD"
