...
HD_PWD='/home/nghielme/PycharmProjects/aca-project/conifer-base/wrapper_heavily_unbalanced/myproject_vivado_accelerator/project_1.runs/design_1_auto_pc_1_synth_1'
cd "$HD_PWD"
