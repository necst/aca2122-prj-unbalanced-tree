set SynModuleInfo {
  ...
  {SRCNAME decision_function MODELNAME decision_function RTLNAME myproject_axi_decision_function
    SUBMODULES {
      ...
      {MODELNAME myproject_axi_mux_63_32_1_0 RTLNAME myproject_axi_mux_63_32_1_0 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME myproject_axi_mux_63_1_1_0 RTLNAME myproject_axi_mux_63_1_1_0 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      ...
      {MODELNAME myproject_axi_mux_83_1_1_0 RTLNAME myproject_axi_mux_83_1_1_0 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME myproject_axi_mux_94_32_1_0 RTLNAME myproject_axi_mux_94_32_1_0 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME myproject_axi_mux_94_1_1_0 RTLNAME myproject_axi_mux_94_1_1_0 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
